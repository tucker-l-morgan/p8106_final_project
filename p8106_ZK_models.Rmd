...
auc = c(roc_rf_impute$auc[1], roc_boost_impute$auc[1], roc_glmnet$auc[1], roc_rf_caret_impute$auc[1], roc_boost_caret_impute$auc[1])

model_names = c("Random Forest w/ Recipes", "Adaboost w/ Recipes", "GLMNet w/ Impute", "Random Forest w/ Caret", "Boost w/ Caret")
