...
index_train = createDataPartition(final_df$ten_year_chd, 
                                  p = 0.8,
                                  list = FALSE)

training_df = final_df[index_train, ]
testing_df = final_df[-index_train, ]
...
```{r auc and roc}
roc_rf = roc(y_test, rf_pred_test_probs)
roc_boost = roc(y_test, boost_pred_test_probs)
...
model_names = c("Random Forest", "Adaboost")
